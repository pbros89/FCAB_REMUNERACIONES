...
class WFModificarFichaModel extends CI_Model
{
    ...
    public function cagarSolicitudesCambioFicha($p_id, $p_cod_emp, $p_rut, $p_usuario, $p_estado, $p_rol, $p_periodo)
    {
        $sql = "SELECT 
                    ...
                    (
                        ...
                        FROM NOV_APROBACIONES_WF APR, NOV_SOL_CAMBIO_FICHA CAM
    ...
    public function cargarRolesWFUsuario($p_usuario, $p_cod_emp) {
        $sql = "SELECT ROL.*
                FROM NOV_ROLES_WF ROL, NOV_USUARIOS_ROLES_WF USR
    ...
    public function crearSolicitudCambioFicha(
        ...
        oci_bind_by_name($proc, "P_SUELDO", $P_SUELDO, -1, OCI_B_INT);
        ...
        oci_bind_by_name($proc, "P_TRAS_BONO", $P_TRAS_BONO, -1, OCI_B_INT);
        ...
        oci_bind_by_name($proc, "P_FK_PERSONAL", $P_FK_PERSONAL, -1, OCI_B_INT);
