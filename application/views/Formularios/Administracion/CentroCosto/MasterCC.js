        ...
        switch (acc) {
          case "INGRESAR":
            Ext.ComponentQuery.query(
              "#MasterCCGrilla #btnIngresar"
            )[0].setHidden(false);
            break;
          case "EDITAR":
            Ext.ComponentQuery.query("#MasterCCGrilla #btnEditar")[0].setHidden(
              false
            );
            break;
        }
...
var clickCrearCC = function (grid) {
  ...
  ventanaDinamica(
    "MasterCCCrear",
    "Crear Centro de Costo (" + NOM_EMPRESA + ")",
    "500",
    "",
    "MasterCCCrear",
    1,
...
var clickEditarCC = function (grid, rowIndex) {
  ...
  ventanaDinamica(
    "MasterCCEditar",
    "Editar Centro de Costo (" + NOM_EMPRESA + ")",
    "500",
    "",
    "MasterCCEditar",
    1,
...
var clickFiltrarCC = function (grid) {
  ...
  ventanaDinamica(
    "MasterCCFiltro",
    "Filtrar Master Centro de Costo (" + NOM_EMPRESA + ")",
    "500",
    "",
    "MasterCCFiltro",
    1,
...
var cargarMasterCC = function (filtros) {
  if (filtros !== null) {
    ...
    Ext.ComponentQuery.query("#MasterCCGrilla #btnLimFiltro")[0].setHidden(
      true
    );
