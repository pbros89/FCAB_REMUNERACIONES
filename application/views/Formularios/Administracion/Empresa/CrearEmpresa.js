Ext.define('fcab.Container.MasterEmpresa.Crear', {
    extend: 'Ext.container.Container',
    xtype: 'MasterEmpresaCrear',
    border: false,
    frame: false,
        ...
        items: [{
            ...
            handler: function () {
                ...
                if (ewin) {
                    ...
                    //console.log(values);
                    storeCrearEmpresa.load({
                        params : {
                            p_cod_emp: values.txtId,
                        ...
                        callback: function(records, operation, success) {
                            if(records != null) {
                                if(records[0].data.r_msg == 'OK'){
                                    ...
                                    Ext.getCmp('MasterEmpresaCrear').destroy();
                                }else{
                                    Ext.MessageBox.show({
                                        title: 'ADVERTENCIA',
