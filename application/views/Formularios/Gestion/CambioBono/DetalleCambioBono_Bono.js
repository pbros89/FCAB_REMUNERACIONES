Ext.define('fcab.Container.DetalleCambioBonoBono', {
    extend: 'Ext.container.Container',
    xtype: 'DetalleCambioBonoBono',
    itemId: 'DetalleCambioBonoBono',
    border: false,
    frame: false,
    scrollable: false,
    listeners: {
        beforerender: function() {
            ...
            storeCargarConceptosCambioBono.load({
                params: {
                    p_bono: param.PK_ID
                }
            });
    ...
    items: [{ 
        xtype: 'DetalleCambioBonoBonoGrilla'
    }]
    
});

Ext.define('fcab.Container.DetalleCambioBonoBono.Grilla', {
    extend: 'Ext.grid.Panel',
    xtype: 'DetalleCambioBonoBonoGrilla',
    itemId: 'DetalleCambioBonoBonoGrilla',
    store: storeCargarConceptosCambioBono,
    columnLines: true,
