...
Ext.define('fcab.Container.IndDistribucionPais.Filtro', {
    extend: 'Ext.form.Panel',
    xtype: 'IndDistribucionPaisFiltro',
    itemId: 'IndDistribucionPaisFiltro',
    border: false,
    padding: 5,
    layout: {
        type: 'column',
    ...
    listeners: {
        beforerender: function(){
            var dataForm = Ext.getCmp('IndDistribucionPaisFiltro').myExtraParams.param2;
            var cmbAnho = Ext.ComponentQuery.query('IndDistribucionPaisFiltro #cmbAnho')[0];
            var cmbEmp = Ext.ComponentQuery.query('IndDistribucionPaisFiltro #cmbEmp')[0];
            var cmbGer = Ext.ComponentQuery.query('IndDistribucionPaisFiltro #cmbGer')[0];
            var cmbDep = Ext.ComponentQuery.query('IndDistribucionPaisFiltro #cmbDep')[0];
            var cmbCC = Ext.ComponentQuery.query('IndDistribucionPaisFiltro #cmbCC')[0];
            var cmbRol = Ext.ComponentQuery.query('IndDistribucionPaisFiltro #cmbRol')[0];
            ...
            listeners: {
                change: function (obj, newValue, oldValue) {
                  Ext.ComponentQuery.query(
                    "IndDistribucionPaisFiltro #cmbGer"
                  )[0].reset();
                  Ext.ComponentQuery.query(
                    "IndDistribucionPaisFiltro #cmbDep"
                  )[0].reset();
                  Ext.ComponentQuery.query(
                    "IndDistribucionPaisFiltro #cmbCC"
                  )[0].reset();
                  if (newValue) {
    ...
    buttons: [{
        ...
        handler: function () {
            ...
            var date = new Date();
            var year = date.getFullYear();
            Ext.ComponentQuery.query('IndDistribucionPaisFiltro #cmbAnho')[0].setValue(year);
            Ext.ComponentQuery.query('IndDistribucionPaisFiltro #cmbEmp')[0].setValue(EMPRESA);
            Ext.ComponentQuery.query('IndDistribucionPaisFiltro #cmbGer')[0].reset();
            Ext.ComponentQuery.query('IndDistribucionPaisFiltro #cmbDep')[0].reset();
            Ext.ComponentQuery.query('IndDistribucionPaisFiltro #cmbCC')[0].reset();
            Ext.ComponentQuery.query('IndDistribucionPaisFiltro #cmbRol')[0].reset();
        }
    },{
        text: 'Filtrar',
        scale: 'small',
        ...
        handler: function () {
            ...
            var grid = Ext.getCmp('IndDistribucionPaisFiltro').myExtraParams.param1;
            ...
            Ext.getCmp('IndDistribucionPaisFiltro').destroy();
