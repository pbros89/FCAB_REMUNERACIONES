Ext.define("fcab.Container.IndDistribucionSexo.Filtro", {
  extend: "Ext.form.Panel",
  xtype: "IndDistribucionSexoFiltro",
  itemId: "IndDistribucionSexoFiltro",
  border: false,
  padding: 5,
  layout: {
    type: "column",
  ...
  listeners: {
    beforerender: function () {
      var dataForm = Ext.getCmp("IndDistribucionSexoFiltro").myExtraParams
        .param2;
      var cmbAnho = Ext.ComponentQuery.query(
        "IndDistribucionSexoFiltro #cmbAnho"
      )[0];
      ...
      var cmbRol = Ext.ComponentQuery.query(
  ...
  buttons: [
    {
      ...
      handler: function () {
        ...
        Ext.ComponentQuery.query("IndDistribucionSexoFiltro #cmbCC")[0].reset();
        Ext.ComponentQuery.query(
          "IndDistribucionSexoFiltro #cmbRol"
        )[0].reset();
      },
    },
    {
      ...
      width: 100,
      handler: function () {
        var grid = Ext.getCmp("IndDistribucionSexoFiltro").myExtraParams.param1;
        ...
        Ext.getCmp("IndDistribucionSexoFiltro").destroy();
      },
    },
  ],
});
