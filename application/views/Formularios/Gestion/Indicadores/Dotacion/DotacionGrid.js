Ext.define("fcab.Container.IndDotacion.Grilla", {
  ...
  store: storeCargarConteoDotacionMensualDinamic,
  columnLines: true,
...
var cargarIndDotacionGrid = function () {
    ...
    storeCargarConteoDotacionMensualDinamic.load({
      params: params,
    });
  };
