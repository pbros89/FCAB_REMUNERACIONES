Ext.define('fcab.Container.ConceptosPersonaProcesoMensual.BDI', {
    extend: 'Ext.container.Container',
    xtype: 'ConceptosPersonaProcesoMensualBDI',
    itemId: 'ConceptosPersonaProcesoMensualBDI',
    border: false,
    frame: false,
    scrollable: false,
    items: [{ 
        xtype: 'ConceptosPersonaProcesoMensualBDIGrilla'
    }]
    
});

Ext.define('fcab.Container.ConceptosPersonaProcesoMensualBDI.Grilla', {
    extend: 'Ext.grid.Panel',
    xtype: 'ConceptosPersonaProcesoMensualBDIGrilla',
    itemId: 'ConceptosPersonaProcesoMensualBDIGrilla',
    store: storeCargarConceptosPersonaProcesoMensualBDI,
    columnLines: true,
