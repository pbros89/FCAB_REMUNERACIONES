Ext.define('fcab.Container.MainProcesoMensual.Crear', {
    ...
    listeners: {
        beforerender : function() {
            var cbAnho = Ext.ComponentQuery.query('#MainProcesoMensualCrear #cbAnho')[0];
            var cbMes = Ext.ComponentQuery.query('#MainProcesoMensualCrear #cbMes')[0];
            var dtFec1 = Ext.ComponentQuery.query('#MainProcesoMensualCrear #dtFec1')[0];
            var dtFec2 = Ext.ComponentQuery.query('#MainProcesoMensualCrear #dtFec2')[0];
            var dtHH1 = Ext.ComponentQuery.query('#MainProcesoMensualCrear #dtHH1')[0];
            var dtHH2 = Ext.ComponentQuery.query('#MainProcesoMensualCrear #dtHH2')[0];
...
Ext.define('fcab.Container.MainProcesoMensual.GrillaValidacion', {
    ...
    listeners: {
        afterrender : function() {
            var params = Ext.getCmp('MainProcesoMensualGrillaValidacion').myExtraParams.param2;
            var mensaje = Ext.getCmp('MainProcesoMensualGrillaValidacion').myExtraParams.param1;
            if(mensaje == 'CORRECTO'){
                Ext.ComponentQuery.query('#MainProcesoMensualGrillaValidacion #txtValidacion')[0].setHtml(
                    '<span style="color:green"><b>CORRECTO</b></span>');
            }else{
                Ext.ComponentQuery.query('#MainProcesoMensualGrillaValidacion #txtValidacion')[0].setHtml(
                    '<span style="color:red"><b>'+mensaje+'</b></span>');
            }
        ...
        items: [{
            ...
            handler: function () {
                this.ownerCt.ownerCt.saveDocumentAs({
                  ...
                  fileName: 'VALIDACION_PROCESO_'+NOM_EMPRESA+' ' + new Date().getTime() +'.xls'
                });
            }
