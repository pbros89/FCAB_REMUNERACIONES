Ext.define('fcab.Container.ConceptosPersonaProcesoMensual.Descuentto', {
    extend: 'Ext.container.Container',
    xtype: 'ConceptosPersonaProcesoMensualDescuento',
    itemId: 'ConceptosPersonaProcesoMensualDescuento',
    border: false,
    frame: false,
    scrollable: false,
    items: [{ 
        xtype: 'ConceptosPersonaProcesoMensualDescuentoGrilla'
    }]
    
});

Ext.define('fcab.Container.ConceptosPersonaProcesoMensualDescuento.Grilla', {
    extend: 'Ext.grid.Panel',
    xtype: 'ConceptosPersonaProcesoMensualDescuentoGrilla',
    itemId: 'ConceptosPersonaProcesoMensualDescuentoGrilla',
    store: storeCargarConceptosPersonaProcesoMensualDescuento,
    columnLines: true,
                    ...
                    return {
                        ...
                        listeners:{
                            change: function(obj, newValue, oldValue){
                                console.log(obj);
                                var param = Ext.getCmp('ConceptosPersonaProcesoMensual').myExtraParams.param2.data;
                                storeModificarValorConceptoPersonaProcesoMensual.load({
                                    params:{
