      ...
      buttons: [
        {
          ...
          handler: function () {
            ...
            if (ewin) {
              ...
              storeGuardarValoresImportacionPersonalizada.proxy.setTimeout(
                300000
              );
...
Ext.define(
  "fcab.Container.DetalleErroresImpotarProcesoMensualPersonalizada.Resumen",
  {
...
Ext.define(
  "fcab.Container.DetalleErroresImpotarProcesoMensualPersonalizada.Detalle",
  {
    extend: "Ext.grid.Panel",
    xtype: "DetalleErroresImpotarProcesoMensualDetallePersonalizada",
...
var cargarErroresImportarProcesoMensualPersonalizada = function () {
  var param = Ext.getCmp("DetalleErroresImpotarProcesoMensualPersonalizada")
    .myExtraParams.param2.data;
