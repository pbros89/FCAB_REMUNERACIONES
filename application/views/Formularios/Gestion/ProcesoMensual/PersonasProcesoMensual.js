        ...
        items: [{
            ...
            listeners:{
                change: function(obj, newValue, oldValue){
                    ...
                    if(newValue != null){
                        var txtDesc = Ext.ComponentQuery.query('#PersonasProcesoMensual #txtDesc')[0].value;
                        var cbEstado = Ext.ComponentQuery.query('#PersonasProcesoMensual #cbEstado')[0].value;
            ...
            listeners:{
                change: function(obj, newValue, oldValue){
                    ...
                    if(newValue != null){
                        var txtDesc = Ext.ComponentQuery.query('#PersonasProcesoMensual #txtDesc')[0].value;
                        var cbCc = Ext.ComponentQuery.query('#PersonasProcesoMensual #cbCc')[0].value;
                                ...
                                callback: function(records, operation, success) {
                                    if(records != null) {
                                        if(records[0].data.r_msg == 'OK'){
                                            Ext.ComponentQuery.query('#PersonasProcesoMensual #cbCc')[0].setValue(null);
        ...
        storeCargarProcesosMensualPersonas.load({
            params: {
                ...
                if(records !== null && records.length > 0) {
                    ...
                    Ext.ComponentQuery.query('#PersonasProcesoMensual #txtProceso')[0].setValue(records[0].data.PK_PROCESO);
                    Ext.ComponentQuery.query('#PersonasProcesoMensual #txtTipo')[0].setValue(records[0].data.PK_TIPO);
                    Ext.ComponentQuery.query('#PersonasProcesoMensual #txtInicio')[0].setValue(records[0].data.INICIO);
                    Ext.ComponentQuery.query('#PersonasProcesoMensual #txtTermino')[0].setValue(records[0].data.TERMINO);
                    Ext.ComponentQuery.query('#PersonasProcesoMensual #txtEstado')[0].setValue(records[0].data.ESTADO);

                    if(records[0].data.ESTADO == 'EN ESPERA') {
                        Ext.ComponentQuery.query('#PersonasProcesoMensual #txtEstado')[0].setFieldStyle( 
                        'background-color: '+rojo+' background-image: none; color: white; font-weight: bold;');
                    }else{
                        Ext.ComponentQuery.query('#PersonasProcesoMensual #txtEstado')[0].setFieldStyle( 
                        'background-color: '+verde+'; background-image: none; color: white; font-weight: bold;');
                    }
                    ...
                    Ext.ComponentQuery.query('#PersonasProcesoMensual')[0].setDisabled(true);
