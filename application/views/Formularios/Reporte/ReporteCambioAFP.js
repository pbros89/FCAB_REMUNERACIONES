Ext.define("fcab.Container.ReporteCambioAFP", {
    extend: 'Ext.container.Container',
    xtype: 'ReporteCambioAFP',
    itemId: 'ReporteCambioAFP',
    layout : 'fit',
    width : '100%',
    border: false,
    frame: false,
    ...
    items: [{
        ...
        border: false,
        frame: false,
        title: 'Cambios AFP Consolidado ('+NOM_EMPRESA+')',
        bodyPadding: 10,
        layout: {
            type: 'column',
            align: 'strech'
                    ...
                    Ext.MessageBox.confirm('Exportar', 'El proceso puede demorarse varios segundos.<br> ¿Desea continuan?', function(btn) {
                        if (btn === 'yes') {
                            ...
                            Ext.create('Ext.form.Panel', {
                                ...
                                standardSubmit: true,
                                url: host + 'excelExport/ExcelExportController/cargarCambiarAFPConsolidado',
                                timeout : 300000,
                            }).submit({
                                params: values,
                                target: 'ReporteCambioAFP' + '-form-iframe',
                                timeout : 300000,
                            });
