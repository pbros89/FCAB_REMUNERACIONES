Ext.define("fcab.Container.ReporteCambioDeposito", {
    extend: 'Ext.container.Container',
    xtype: 'ReporteCambioDeposito',
    itemId: 'ReporteCambioDeposito',
    layout : 'fit',
    width : '100%',
    border: false,
    frame: false,
    ...
    items: [{
        ...
        border: false,
        frame: false,
        title: 'Cambios Deposito Remuneración Consolidado ('+NOM_EMPRESA+')',
        bodyPadding: 10,
        layout: {
            type: 'column',
            align: 'strech'
                    ...
                    Ext.MessageBox.confirm('Exportar', 'El proceso puede demorarse varios segundos.<br> ¿Desea continuan?', function(btn) {
                        if (btn === 'yes') {
                            Ext.create('Ext.form.Panel', {
                                ...
                                standardSubmit: true,
                                url: host + 'excelExport/ExcelExportController/cargarCambiarDepositoConsolidado',
                                timeout : 300000,
                            }).submit({
                                params: values,
                                target: 'ReporteCambioDeposito' + '-form-iframe',
                                timeout : 300000,
                            });
                        }
                    });
