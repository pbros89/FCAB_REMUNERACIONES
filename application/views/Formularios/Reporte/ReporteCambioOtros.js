Ext.define("fcab.Container.ReporteCambioOtros", {
    extend: 'Ext.container.Container',
    xtype: 'ReporteCambioOtros',
    itemId: 'ReporteCambioOtros',
    layout : 'fit',
    width : '100%',
    border: false,
    frame: false,
    ...
    items: [{
        ...
        border: false,
        frame: false,
        title: 'Cambios Otros Consolidado ('+NOM_EMPRESA+')',
        bodyPadding: 10,
        layout: {
            type: 'column',
            align: 'strech'
                    ...
                    Ext.MessageBox.confirm('Exportar', 'El proceso puede demorarse varios segundos.<br> ¿Desea continuan?', function(btn) {
                        if (btn === 'yes') {
                            ...
                            Ext.create('Ext.form.Panel', {
                                ...
                                standardSubmit: true,
                                timeout : 300000,
                                url: host + 'excelExport/ExcelExportController/cargarCambiarOtrosConsolidado'
                            }).submit({
                                params: values,
                                timeout : 300000,
                                target: 'ReporteCambioOtros' + '-form-iframe',
                            });
                        }
                    });
