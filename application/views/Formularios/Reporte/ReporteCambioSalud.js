Ext.define("fcab.Container.ReporteCambioSalud", {
    extend: 'Ext.container.Container',
    xtype: 'ReporteCambioSalud',
    itemId: 'ReporteCambioSalud',
    layout : 'fit',
    width : '100%',
    border: false,
    frame: false,
    ...
    items: [{
        ...
        border: false,
        frame: false,
        title: 'Cambios Salud Consolidado ('+NOM_EMPRESA+')',
        bodyPadding: 10,
        layout: {
            type: 'column',
            align: 'strech'
                    ...
                    Ext.MessageBox.confirm('Exportar', 'El proceso puede demorarse varios segundos.<br> ¿Desea continuan?', function(btn) {
                        if (btn === 'yes') {
                            Ext.create('Ext.form.Panel', {
                                ...
                                standardSubmit: true,
                                timeout : 300000,
                                url: host + 'excelExport/ExcelExportController/cargarCambiarSaludConsolidado'
                            }).submit({
                                params: values,
                                timeout : 300000,
                                target: 'ReporteCambioSalud' + '-form-iframe',
                            });
                        }
                    });
