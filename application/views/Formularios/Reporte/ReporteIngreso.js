Ext.define("fcab.Container.ReporteIngresoConsolidado", {
    extend: 'Ext.container.Container',
    xtype: 'ReporteIngresoConsolidado',
    itemId: 'ReporteIngresoConsolidado',
    layout : 'fit',
    width : '100%',
    border: false,
    frame: false,
    ...
    items: [{
        ...
        border: false,
        frame: false,
        title: 'Ingreso Consolidado ('+NOM_EMPRESA+')',
        bodyPadding: 10,
        layout: {
            type: 'column',
            align: 'strech'
                    ...
                    Ext.MessageBox.confirm('Exportar', 'El proceso puede demorarse varios segundos.<br> ¿Desea continuan?', function(btn) {
                        if (btn === 'yes') {
                            Ext.create('Ext.form.Panel', {
                                ...
                                standardSubmit: true,
                                url: host + 'excelExport/ExcelExportController/cargarIngresarPersonalConsolidado',
                                timeout : 300000,
                            }).submit({
                                params: values,
                                target: 'ReporteIngresoConsolidado' + '-form-iframe',
                                timeout : 300000,
                            });
                        }
                    });
