...
Ext.define("fcab.Container.WF.ModificarFicha.Inicio.Grilla", {
  ...
  title: "WF Modificación Datos Laborales (" + NOM_EMPRESA + ")",
  columnLines: true,
  ...
  columns: [
    ...
    },
    {
      text: "Motivo",
      sortable: true,
      dataIndex: "NOM_MOTIVO",
      hidden: false,
      width: 150,
      renderer: function (value, meta) {
        var finalValue = value == "" || value == null ? "ANEXO VINCULANTE" : value;
        return finalValue;
      },
    },
    {
    ...
    {
      text: "Tras. ID Contrato",
      sortable: true,
      dataIndex: "TRAS_COD_CONTRATO",
      hidden: true,
      width: 100,
    },
    {
    ...
    {
      text: "Tras. Indefinido",
      sortable: true,
      dataIndex: "TRAS_INDEFINIDO",
      hidden: true,
      width: 100,
    },
  ],
