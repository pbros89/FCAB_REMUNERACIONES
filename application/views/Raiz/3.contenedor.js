        ...
        if (acc == "VER") {
          switch (accion.PFK_PANTALLA) {
            ...
            case "REPORT_CAMBIO_DEPOSITO":
              if (estado == "A") {
                var p = rootReporte.items.items[0].store.getById(
                  "menu_reporte_cambio_depositorem"
                );
                p.data.cls = "";
                countReporte++;
              }
            ...
            case "REPORT_CAMBIO_CARGO":
              if (estado == "A") {
                var p = rootReporte.items.items[0].store.getById(
                  "menu_reporte_cambio_cargorenta"
                );
                p.data.cls = "";
                countReporte++;
              }
            ...
            case "REPORT_ING_DESCUENTO_RRLL":
              if (estado == "A") {
                var p = rootReporte.items.items[0].store.getById(
                  "menu_reporte_ing_descuento_rrll"
                );
                p.data.cls = "";
                countReporte++;
              }
