...
var storeCargarConteoDotacionEtariaMensual =  Ext.create('Ext.data.Store', {
    ...
    proxy: {
        type:   'ajax',
        url:    JsonHost + 'indicador/IndicadorController/cargarConteoDotacionEtariaMensual',
        reader: {
            type: 'json',
            rootProperty: 'items'
        },
...
var storeCargarConteoDotacionEtariaMensualDet =  Ext.create('Ext.data.Store', {
    ...
    proxy: {
        type:   'ajax',
        url:    JsonHost + 'indicador/IndicadorController/cargarConteoDotacionEtariaMensualDet',
        reader: {
            type: 'json',
            rootProperty: 'items'
        },
...
var storeCargarConteoDotacionAntiguedadMensual =  Ext.create('Ext.data.Store', {
    ...
    proxy: {
        type:   'ajax',
        url:    JsonHost + 'indicador/IndicadorController/cargarConteoDotacionAntiguedadMensual',
        reader: {
            type: 'json',
            rootProperty: 'items'
        },
...
var storeCargarConteoDotacionAntiguedadMensualDet =  Ext.create('Ext.data.Store', {
   
    proxy: {
        type:   'ajax',
        url:    JsonHost + 'indicador/IndicadorController/cargarConteoDotacionAntiguedadMensualDet',
        reader: {
            type: 'json',
            rootProperty: 'items'
        },
...
var storeCargarConteoDotacionRolPaisMensual =  Ext.create('Ext.data.Store', {
    ...
    proxy: {
        type:   'ajax',
        url:    JsonHost + 'indicador/IndicadorController/cargarConteoDotacionRolPaisMensual',
        reader: {
            type: 'json',
            rootProperty: 'items'
        },
...
var storeCargarConteoDotacionRolPaisMensualDet =  Ext.create('Ext.data.Store', {
    ...
    proxy: {
        type:   'ajax',
        url:    JsonHost + 'indicador/IndicadorController/cargarConteoDotacionRolPaisMensualDet',
        reader: {
            type: 'json',
            rootProperty: 'items'
        },
...
var storeCargarConteoDotacionRolSexoMensual =  Ext.create('Ext.data.Store', {
    ...
    proxy: {
        type:   'ajax',
        url:    JsonHost + 'indicador/IndicadorController/cargarConteoDotacionRolSexoMensual',
        reader: {
            type: 'json',
            rootProperty: 'items'
        },
...
var storeCargarConteoDotacionRolSexoMensualDet =  Ext.create('Ext.data.Store', {
    ...
    proxy: {
        type:   'ajax',
        url:    JsonHost + 'indicador/IndicadorController/cargarConteoDotacionRolSexoMensualDet',
        reader: {
            type: 'json',
            rootProperty: 'items'
        },
...
var storeCargarConteoRotacionConsolidado =  Ext.create('Ext.data.Store', {
    ...
    proxy: {
        type:   'ajax',
        url:    JsonHost + 'indicador/IndicadorController/cargarConteoRotacionConsolidado',
        reader: {
            type: 'json',
            rootProperty: 'items'
        },
...
var storeCargarConteoDotacionGerencia =  Ext.create('Ext.data.Store', {
    ...
    proxy: {
        type:   'ajax',
        url:    JsonHost + 'indicador/IndicadorController/cargarConteoDotacionGerencia',
        reader: {
            type: 'json',
            rootProperty: 'items'
        },
...
var storeValidarImportarDiasTrabajados = Ext.create('Ext.data.Store', {
    ...
    proxy: {
        type:   'ajax',
        url:    JsonHost + 'indicador/IndicadorController/validarImportarDiasTrabajados',
        reader: {
            type: 'json',
            rootProperty: 'items'
        },
...
var storeResumenValidarImportarDiasTrabajados = Ext.create('Ext.data.Store', {
    ...
    proxy: {
        type:   'ajax',
        url:    JsonHost + 'indicador/IndicadorController/resumenValidarImportarDiasTrabajados',
        reader: {
            type: 'json',
            rootProperty: 'items'
        },
...
var storeGuardarImportarDiasTrabajados = Ext.create('Ext.data.Store', {
    ...
    proxy: {
        type:   'ajax',
        url:    JsonHost + 'indicador/IndicadorController/guardarImportarDiasTrabajados',
        reader: {
            type: 'json',
            rootProperty: 'items'
        },
...
var storeCargarConteoAusentismoMensual = Ext.create('Ext.data.Store', {
    ...
    proxy: {
        type:   'ajax',
        url:    JsonHost + 'indicador/IndicadorController/cargarConteoAusentismoMensual',
        reader: {
            type: 'json',
            rootProperty: 'items'
        },
...
var storeCargarConteoAusentismoGerencia = Ext.create('Ext.data.Store', {
    ...
    proxy: {
        type:   'ajax',
        url:    JsonHost + 'indicador/IndicadorController/cargarConteoAusentismoGerencia',
        reader: {
            type: 'json',
            rootProperty: 'items'
        },
